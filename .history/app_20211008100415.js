...
horizontals.forEach((row, rowIndex) => {
    row.forEach((open, colIndex) => {
        ...
        const wall = Bodies.rectangle(colIndex * unitLengthX + unitLengthX / 2, rowIndex * unitLengthY + unitLengthY, unitLength, wallsThickness, 
            {
                label: 'wall',
                isStatic: true
            });
...
//====== Goal & Player Piece
const goal =Bodies.circle(width - unitLengthX / 2, height - unitLengthY / 2, goalRadius, 
    {
        label: 'goal',
        isStatic: true
    });
const playerPiece =Bodies.circle(unitLengthX / 2, unitLengthY / 2, goalRadius,
    {
        label: 'player'
    });
