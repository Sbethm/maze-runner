...
verticals.forEach((row, rowIndex) => {
    row.forEach((open, colIndex) => {
        ...
        const wall = Bodies.rectangle(rowIndex * unitLength + unitLength, colIndex * unitLength + unitLength / 2, wallsThickness, unitLength, {isStatic: true});
        World.add(world, wall);
    });
});