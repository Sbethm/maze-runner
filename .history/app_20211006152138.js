...
//====== Goal
const goal =Bodies.circle(cells - unitLength / 2, cells - unitLength / 2, 5, {isStatic: true});
const goal2 =Bodies.circle(cells - unitLength / 2, cells - unitLength / 2, 5, {isStatic: true});
console.log(goal);
console.log(width - unitLength / 2);
